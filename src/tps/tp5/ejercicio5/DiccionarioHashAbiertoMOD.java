...
public class DiccionarioHashAbiertoMOD<K,V> implements Dictionary<K,V>{
    protected PositionList<Entry<K,V>>[]A;
    protected int entradas;
    protected int buckets=13;

    public DiccionarioHashAbiertoMOD(){
        entradas=0;
...
/*
Agregue una operación a la clase Diccionario<K,V> programada en el ejercicio 3 con la siguiente signatura:
Iterable<Entry<K,V>> eliminarTodas(K c,V v) throws InvalidKeyException. Este método debe eliminar del
diccionario todas aquellas entradas con clave c y valor v. Retorna un iterable con todas las entradas
eliminadas.
 */